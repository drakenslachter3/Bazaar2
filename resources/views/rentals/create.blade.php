                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-8">
                            ...
                            <p class="text-primary fw-bold">{{ __('Price') }}: €{{ number_format($advertisement->price, 2) }} {{ __('per day') }}</p>
                    ...
                    <form method="POST" action="{{ route('rentals.store', $advertisement) }}">
                        ...
                        <div class="mb-3 row">
                            <label for="start_date" class="col-md-4 col-form-label text-md-end">{{ __('Start Date') }} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" required min="{{ date('Y-m-d', strtotime('+1 day')) }}" value="{{ old('start_date') }}">
                                @error('start_date')
                        ...
                        <div class="mb-3 row">
                            <label for="end_date" class="col-md-4 col-form-label text-md-end">{{ __('End Date') }} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" required min="{{ date('Y-m-d', strtotime('+2 days')) }}" value="{{ old('end_date') }}">
                                @error('end_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
