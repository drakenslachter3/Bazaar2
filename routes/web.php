...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/my-rentals', [RentalController::class, 'myRentals'])->name('my.rentals')->middleware('auth');

    // Verhuurverzoeken voor adverteerders
    Route::get('/advertiser/rental-requests', [AdvertiserController::class, 'rentalRequests'])->name('advertiser.rental.requests');
    Route::post('/advertiser/rental-requests/{rental}', [AdvertiserController::class, 'updateRentalRequest'])->name('advertiser.rental.update');
});
